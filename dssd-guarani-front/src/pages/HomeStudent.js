...
import FinalInscription from '../components/StudentInscription/FinalInscription/index';
        ...
        <Router history={history}>
            <div className={classes.root}>
                ...
                <div className='mainContainer'>
                    ...
                    <Route path="/inscriptionFinal" render={(props) => <FinalInscription open={open} classes={classes} {...props} /> } />
